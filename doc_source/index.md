...
+ [Working with the AWS Cloud9 Integrated Development Environment (IDE)](ide.md)
   ...
   + [Enhanced language support in the AWS Cloud9 Integrated Development Environment (IDE)](enhanced-lang-support.md)
      + [Enhanced support for Java development](enhanced-java.md)
      + [Enhanced TypeScript support with with language projects](projects.md)
...
+ [Working with other AWS services](working-with-other-services.md)
   ...
   + [Working with Amazon CodeWhisperer by using AWS Cloud9](codewhisperer.md)
...
+ [AWS Toolkit](toolkit-welcome.md)
   ...
   + [Working with CloudWatch Logs using the AWS Toolkit](cloudwatch-logs-toolkit.md)
      + [Viewing CloudWatch log groups and log streams using the AWS Toolkit](viewing-CloudWatch-logs.md)
      + [Working with CloudWatch log events in log streams by using the AWS Toolkit](working-CloudWatch-log-events.md)
...
+ [Tutorials and samples for AWS Cloud9](tutorials.md)
   ...
   + [AWS CDKsample for AWS Cloud9](sample-cdk.md)
   + [LAMP sample for AWS Cloud9](sample-lamp.md)
   + [Installing WordPress for AWS Cloud9](sample-wordpress.md)
