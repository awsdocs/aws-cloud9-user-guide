...
Start using AWS Cloud9 by following the steps in [Getting Started](get-started.md)\.
...
|  **Scenario**  |  **Resources**  | 
| --- | --- | 
|  Create, run, and debug code in AWS Lambda functions, APIs in Amazon API Gateway, and serverless applications\.  |   [AWS Lambda Tutorial](tutorial-lambda.md), [Advanced AWS Lambda Tutorial](tutorial-lambda-advanced.md), and [Working with AWS Lambda Functions](lambda-functions.md)   | 
...
|  Work with code in AWS software development projects and toolchains in AWS CodeStar\.  |   [Working with AWS CodeStar Projects](codestar-projects.md)   | 
|  Work with code in continuous delivery solutions in AWS CodePipeline\.  |   [Working with AWS CodePipeline](codepipeline-repos.md)   | 
|  Automate AWS services by using the AWS CLI and the aws\-shell\.  |   [AWS CLI and aws\-shell Sample](sample-aws-cli.md)   | 
|  Work with source code repositories in AWS CodeCommit\.  |   [AWS CodeCommit Sample](sample-codecommit.md)   | 
|  Work with source code repositories in GitHub\.  |   [GitHub Sample](sample-github.md)   | 
|  Work with NoSQL databases in Amazon DynamoDB\.  |   [Amazon DynamoDB Sample](sample-dynamodb.md)   | 
|  Work with code for Java and the AWS SDK for Java\.  |   [Java Sample](sample-java.md)   | 
|  Work with code for C\+\+ and the AWS SDK for C\+\+\.  |   [C\+\+ Sample](sample-cplusplus.md)   | 
|  Work with code for Python and the AWS SDK for Python \(Boto\)\.  |   [Python Sample](sample-python.md)   | 
|  Work with code for \.NET Core and the AWS SDK for \.NET\.  |   [\.NET Core Sample](sample-dotnetcore.md)   | 
|  Work with code for Node\.js and the AWS SDK for JavaScript\.  |   [Node\.js Sample](sample-nodejs.md)   | 
|  Work with code for PHP and the AWS SDK for PHP\.  |   [PHP Sample](sample-php.md)   | 
|  Work with code for Ruby and the AWS SDK for Ruby\.  |   [Ruby Sample](sample-ruby.md)   | 
|  Work with code for Go and the AWS SDK for Go\.  |   [Go Sample](sample-go.md)   | 
|  Work with code for TypeScript and the AWS SDK for JavaScript\.  |   [TypeScript Sample](sample-typescript.md)   | 
|  Work with code for the AWS Cloud Development Kit \(AWS CDK\)\.  |   [AWS CDK Sample](sample-cdk.md)   | 
|  Work with code in a running Docker container\.  |   [Docker Sample](sample-docker.md)   | 
|  Invite others to use an environment along with you, in real time and with text chat support\.  |   [Working with Shared Environments](share-environment.md)   | 
...
+  [AWS Sydney Summit 2018: AWS Cloud9 and CodeStar](https://www.youtube.com/watch?v=B-nbl0qYsQg) \(25 minutes, YouTube website\)
