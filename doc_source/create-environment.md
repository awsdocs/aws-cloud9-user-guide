...
|  You, by using [AWS CodePipeline](https://aws.amazon.com/codepipeline)   |  AWS Cloud9 or you  |  This topic \(create an [EC2](#create-environment-main) or [SSH](#create-environment-ssh) environment\), and then see [Working with AWS CodePipeline in the AWS Cloud9 Integrated Development Environment \(IDE\)](codepipeline-repos.md)   | 
...
|  You, by using [GitHub](https://github.com/)   |  AWS Cloud9 or you  |  This topic \(create an [EC2](#create-environment-main) or [SSH](#create-environment-ssh) environment\), and then see the [GitHub Sample for AWS Cloud9](sample-github.md)   | 
...
1. Make sure you completed the steps in [Getting Started with AWS Cloud9](get-started.md) first, so that you can sign in to the AWS Cloud9 console and create environments\.
...
**Note**  
Make sure you completed the steps in [Getting Started with AWS Cloud9](get-started.md) first, so that you can create environments\.  
