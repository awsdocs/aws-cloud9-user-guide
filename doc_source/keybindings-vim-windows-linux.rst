...
.. _keybindings-vim-windows-linux:

###################################################################
Windows / Linux Vim Keybindings Reference for the |AC9IDElongtitle|
###################################################################
...
Following is a list of Vim keyboard mode keybindings for Windows / Linux operating systems in the |AC9IDE|.
...
* :ref:`keybindings-vim-windows-linux-general`
* :ref:`keybindings-vim-windows-linux-tabs`
* :ref:`keybindings-vim-windows-linux-panels`
* :ref:`keybindings-vim-windows-linux-code-editor`
* :ref:`keybindings-vim-windows-linux-emmet`
* :ref:`keybindings-vim-windows-linux-terminal`
* :ref:`keybindings-vim-windows-linux-run-debug`

.. _keybindings-vim-windows-linux-general:
...
.. _keybindings-vim-windows-linux-tabs:
...
.. _keybindings-vim-windows-linux-panels:
...
.. _keybindings-vim-windows-linux-code-editor:
...
.. list-table::
   ...
   * - Copy the contents of the line, and paste the copied contents one line up
     - :kbd:`Alt-Shift-Up`
     - :code:`copylinesup`
   * - Cut the selection. If there is no selection, delete one space
     - :kbd:`Shift-Delete`
     - :code:`cut_or_delete`
   * - Delete one space
     - :kbd:`Delete`
...
.. _keybindings-vim-windows-linux-emmet:
...
.. _keybindings-vim-windows-linux-terminal:
...
.. _keybindings-vim-windows-linux-run-debug:
