...
###################################
Opening an Environment in |AC9long|
###################################

.. meta::
    :description:
        Describes how to open an environment in AWS Cloud9.

This procedure describes how to open an environment in |AC9long|.
...
#. In the list of environments, for the |env| you want to open, do one of the following.
   ...
   * Inside of the card, choose the :guilabel:`Open IDE` link.
     ...
     .. image:: images/console-open-ide.png
        :alt: Choosing an environment using the Open IDE link
   
   * Select the card, and then choose the :guilabel:`Open IDE` button.

     .. image:: images/console-open-ide-card.png
        :alt: Choosing an environment using the Open IDE button
